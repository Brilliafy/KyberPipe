/// BIP-39 English wordlist (2048 words) for generating human-readable wormhole codes.
pub(crate) const BIP39_WORDS: &[&str] = &[
    ...
    "anchor", "angel", "anger", "angle", "angry", "animal", "ankle", "announce", "annual",
    ...
    "expect", "expire", "explain", "expose", "express", "extend", "extra", "eyebrow", "fabric",
    ...
    "foil", "fold", "follow", "food", "foot", "force", "foreign", "forest", "forget", "fork",
    ...
    "impact", "impose", "improve", "impulse", "include", "income", "increase", "index", "indicate",
    ...
    "october", "odor", "off", "offend", "offer", "office", "often", "oil", "okay", "old", "olive",
    ...
    "property", "proposal", "protect", "provide", "public", "pulse", "pumpkin", "punch", "pupil",
    ...
    "rigid", "ring", "riot", "rip", "ripe", "rise", "risk", "rival", "river", "road", "roast",
    ...
    "sure", "surface", "surge", "surround", "survey", "suspect", "sustain", "swallow", "swamp",
